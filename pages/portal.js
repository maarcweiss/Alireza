...
export default function Sell() {
  ...
  async function getWalletNFTs() {
    //mainnet comes from configuration.js
    ...
    //the loop consists of for each in tokensupply
    //we are going to take the owner of token id
    contract.totalSupply().then((result) => {
      //change from headecimal to integer
    ...
    //wait 3 seconds to let the html to render
    await new Promise((r) => setTimeout(r, 3000));
    setNfts(itemArray);
    setLoadingState("loaded");
  }
  //if you dont have the nfo yet, consider that you do not have the NFTS and then it will display the message, no NFTs found
